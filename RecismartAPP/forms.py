...
class CuentaUsuarioCreationForm(UserCreationForm):
    ...
    class Meta:
        model = CuentaUsuario
        fields = ['Rut', 'Rut_Empresa', 'Nombre_de_empresa', 'first_name', 'last_name', 'Telefono', 'email', 'Direccion', 'Comuna', 'Region', 'Usuario_administrador', 'Usuario_normal', 'Usuario_recolector', 'username', 'password1', 'password2']
